...
const defaultDlEmbed = new MessageEmbed()
	.setColor(0x4e4e4e)
	.setTitle('Dragonlord:')
	.addFields(
...
const defaultEdlEmbed = new MessageEmbed()
	.setColor(0x4e4e4e)
...
const defaultHeliEmbed = new MessageEmbed()
	.setColor(0x4e4e4e)
	.setTitle('Heliants:')
	.addFields(
...
const defaultEgEmbed = new MessageEmbed()
	.setColor(0x4e4e4e)
	.setTitle('End Game:')
...
export const createEmbeds = (channel) => {
    channel.send({ embeds: [defaultDlEmbed, defaultEdlEmbed, defaultHeliEmbed, defaultEgEmbed] })
};

export const editEmbeds = (channel, boss_name, new_time) => {
...
export const readEmbedsRecreateTimers = () => {
